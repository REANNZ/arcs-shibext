...
public class SharedTokenDataConnector extends AbstractDataConnector {
	...
	private String generatedAttributeId = "auEduPersonSharedToken";
	...
	private boolean storeLdap = false;
	...
	private boolean storeDatabase = false;
	...
	protected void doInitialize() throws ComponentInitializationException {
		...
		// warn if both storeLdap=false and storeDatabase=false
		...
		// check if attributes listed in sourceAttributeId can be found in the provided dependencies (InputAttrDef/InputDC)
		...
		try {
			if (storeDatabase) {
				...
				if (ldapConnectorId != null) {
					...
					Map<String,IdPAttribute> resolvedAttributes = ldapDcResolved.getResolvedAttributes();
					if (resolvedAttributes != null) {
						sharedTokenFromLDAP = resolvedAttributes.get(storedAttributeName);
					}
				}
